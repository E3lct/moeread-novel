      ...
      <div class="home-top">
        ...
        <div class="recommend-card" v-if="recommendBook" @click="goReader(recommendBook)">
          ...
          <div class="recommend-body">
            <div class="recommend-cover" :class="`cover-${(recommendBook.id % 6) + 1}`">
              <span class="recommend-cover-title">{{ recommendBook.title }}</span>
            </div>
      ...
      <div class="home-section" v-if="recentBooks.length">
        ...
        <div class="book-row">
          <div class="home-book" v-for="book in recentBooks" :key="book.id" @click="goReader(book)">
            <div class="home-book-cover" :class="`cover-${(book.id % 6) + 1}`">
              <span class="home-book-cover-title">{{ book.title }}</span>
...
.home-book-cover {
    ...
    justify-content: center;
    padding: 14px;
    box-shadow: 0 3px 10px rgba(217, 119, 6, 0.16);
    position: relative;
    overflow: hidden;
